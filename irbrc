# My environment:
# - Newest RVM
# - Ruby 1.9.2 with readline support, see http://goo.gl/dbj4W.
# Pre-requisites:
# gem install awesome_print bond hirb looksee map_by_method net-http-spy sketches what_methods wirble
